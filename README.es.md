...
- **Skill `/resume-claude`**: Flujo de 6 pasos — detectar → comparar → confirmar → importar → resumir → continuar. Palabras clave: "resume claude", "retomar claude", "continuar trabajo".
